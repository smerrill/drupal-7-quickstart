...
/**
 * Begin OpenShift configuration.
 * This will use the proper OpenShift MySQL, memcached, and Redis settings if you are
 * running on OpenShift, and will not use them if you run this repository locally.
 */

// When run from Drush, only $_ENV is available.
if (array_key_exists('OPENSHIFT_APP_NAME', $_SERVER)) {
  $src = $_SERVER;
} elseif (array_key_exists('OPENSHIFT_APP_NAME', $_ENV)) {
  $src = $_ENV;
}

// Only use these settings if we are on OpenShift.
if (isset($src)) {
  // Check for MySQL.
  if (array_key_exists('OPENSHIFT_MYSQL_DB_USERNAME', $src)) {
    $databases = array (
      'default' =>
      array (
        'default' =>
  ...
  // @TODO: Set up memcached if it is present.
  // @TODO: Set up Redis if it is present.
  // Use the data dir for private files.
